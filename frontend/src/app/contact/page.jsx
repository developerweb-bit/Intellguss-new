        ...
        <div className="w-full max-w-6xl">
          ...
          <div className="relative bg-white  rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-2">
              {/* Left Panel */}
              <div className="p-10 md:pl-14 md:pr-8 lg:pl-20 lg:pr-12 overflow-hidden relative">
                <div
                  className="rounded-xl  relative overflow-hidden h-full cursor-non p-6 pb-10 bg-gradient-to-br from-blue-50 via-white to-blue-50 flex flex-col justify-between items-start"
                  aria-hidden="false"
